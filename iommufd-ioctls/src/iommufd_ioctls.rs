...
impl Drop for IommufdVIommu {
    fn drop(&mut self) {
        self.iommufd
            .destroy_iommu_object(self.viommu_id)
            .inspect_err(|e| {
        ...
        self.iommufd
            .destroy_iommu_object(self.s2_hwpt_id)
            .inspect_err(|e| {
        ...
        self.iommufd
            .destroy_iommu_object(self.bypass_hwpt_id)
            .inspect_err(|e| {
                eprintln!(
        ...
        self.iommufd
            .destroy_iommu_object(self.abort_hwpt_id)
            .inspect_err(|e| {
                eprintln!(
...
impl Drop for IommufdVDevice {
    fn drop(&mut self) {
        self.viommu
            .iommufd
            .destroy_iommu_object(self.vdevice_id)
            .inspect_err(|e| {
        ...
        if let Some(s1_hwpt_id) = self.s1_hwpt_id {
            self.viommu
                .iommufd
                .destroy_iommu_object(s1_hwpt_id)
                .inspect_err(|e| {
